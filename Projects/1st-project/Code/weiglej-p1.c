...
void draw_dodecahedron()
{
    ...
    static GLfloat vertexValues[] = {
        459.6, 565.2, 0.0, 0.00, 0.00, 0.00,    //0     back
        664.9, 422.8, 0.0, 0.00, 0.00, 0.00,    //1
        658.8, 411.9, 0.0, 0.00, 0.00, 0.00,    //2
        453.0, 552.9, 0.0, 0.00, 0.00, 0.00,    //3_1
        654.0, 419.7, 0.0, 0.00, 0.00, 0.00,    //4
        665.7, 415.7, 0.0, 0.00, 0.00, 0.00,    //5
        590.6, 191.7, 0.0, 0.00, 0.00, 0.00,    //6
        577.4, 195.0, 0.0, 0.00, 0.00, 0.00,    //7_2
        583.8, 197.3, 0.0, 0.00, 0.00, 0.00,    //8
        586.8, 189.4, 0.0, 0.00, 0.00, 0.00,    //9
        330.6, 191.5, 0.0, 0.00, 0.00, 0.00,    //10
        330.4, 198.1, 0.0, 0.00, 0.00, 0.00,    //11_3
        326.7, 190.1, 0.0, 0.00, 0.00, 0.00,    //12
        251.3, 419.6, 0.0, 0.00, 0.00, 0.00,    //13
        261.1, 421.6, 0.0, 0.00, 0.00, 0.00,    //14
        334.8, 194.0, 0.0, 0.00, 0.00, 0.00,    //15_4
        253.8, 425.9, 0.0, 0.00, 0.00, 0.00,    //16
        455.1, 563.1, 0.0, 0.00, 0.00, 0.00,    //17
        461.9, 551.5, 0.0, 0.00, 0.00, 0.00,    //18
        259.3, 414.1, 0.0, 0.00, 0.00, 0.00,    //19_5  endback
        585.2, 198.9, 0.0, 0.00, 0.00, 0.00,    //20    base
        685.8, 141.1, 0.0, 0.00, 0.00, 0.00,    //21
        678.2, 136.0, 0.0, 0.00, 0.00, 0.00,    //22
        582.6, 190.5, 0.0, 0.00, 0.00, 0.00,    //23_1
        681.6, 139.6, 0.0, 0.00, 0.00, 0.00,    //24
        683.1, 129.3, 0.0, 0.00, 0.00, 0.00,    //25
        459.0, 86.50, 0.0, 0.00, 0.00, 0.00,    //26
        459.7, 97.50, 0.0, 0.00, 0.00, 0.00,    //27_2
        459.0, 86.50, 0.0, 0.00, 0.00, 0.00,    //28
        222.4, 127.0, 0.0, 0.00, 0.00, 0.00,    //29
        227.3, 135.2, 0.0, 0.00, 0.00, 0.00,    //30
        461.1, 96.90, 0.0, 0.00, 0.00, 0.00,    //31_3
        225.1, 139.0, 0.0, 0.00, 0.00, 0.00,    //32
        331.0, 197.8, 0.0, 0.00, 0.00, 0.00,    //33
        335.1, 191.7, 0.0, 0.00, 0.00, 0.00,    //34
        229.8, 134.5, 0.0, 0.00, 0.00, 0.00,    //35_4  endbase
        222.4, 127.0, 0.0, 0.00, 0.00, 0.00,    //36    bklbot
        70.60, 364.5, 0.0, 0.00, 0.00, 0.00,    //37
        80.20, 368.3, 0.0, 0.00, 0.00, 0.00,    //38
        231.5, 132.2, 0.0, 0.00, 0.00, 0.00,    //39_1
        70.60, 364.5, 0.0, 0.00, 0.00, 0.00,    //40
        101.7, 539.3, 0.0, 0.00, 0.00, 0.00,    //41
        112.2, 539.8, 0.0, 0.00, 0.00, 0.00,    //42
        80.50, 368.5, 0.0, 0.00, 0.00, 0.00,    //43_2
        112.2, 539.8, 0.0, 0.00, 0.00, 0.00,    //44
        261.7, 423.6, 0.0, 0.00, 0.00, 0.00,    //45
        257.2, 414.4, 0.0, 0.00, 0.00, 0.00,    //46
        105.5, 528.0, 0.0, 0.00, 0.00, 0.00,    //47_3  endbklbot
        101.7, 539.3, 0.0, 0.00, 0.00, 0.00,    //48    bkltop
        227.8, 767.0, 0.0, 0.00, 0.00, 0.00,    //49
        232.7, 758.0, 0.0, 0.00, 0.00, 0.00,    //50
        109.1, 536.0, 0.0, 0.00, 0.00, 0.00,    //51_1
        227.8, 767.0, 0.0, 0.00, 0.00, 0.00,    //52
        458.0, 765.8, 0.0, 0.00, 0.00, 0.00,    //53
        457.8, 754.2, 0.0, 0.00, 0.00, 0.00,    //54
        232.7, 758.0, 0.0, 0.00, 0.00, 0.00,    //55_2
        449.4, 761.0, 0.0, 0.00, 0.00, 0.00,    //56
        464.4, 761.1, 0.0, 0.00, 0.00, 0.00,    //57
        465.2, 554.8, 0.0, 0.00, 0.00, 0.00,    //58
        450.3, 556.9, 0.0, 0.00, 0.00, 0.00,    //59_3  endbkltop
        458.0, 765.8, 0.0, 0.00, 0.00, 0.00,    //60    bkrtop
        683.7, 765.4, 0.0, 0.00, 0.00, 0.00,    //61
        686.0, 754.6, 0.0, 0.00, 0.00, 0.00,    //62
        457.8, 754.2, 0.0, 0.00, 0.00, 0.00,    //63_1
        683.7, 765.4, 0.0, 0.00, 0.00, 0.00,    //64
        809.5, 539.9, 0.0, 0.00, 0.00, 0.00,    //65
        803.7, 535.8, 0.0, 0.00, 0.00, 0.00,    //66
        679.6, 757.0, 0.0, 0.00, 0.00, 0.00,    //67_2
        803.7, 535.8, 0.0, 0.00, 0.00, 0.00,    //68
        808.2, 527.8, 0.0, 0.00, 0.00, 0.00,    //69
        660.8, 411.0, 0.0, 0.00, 0.00, 0.00,    //70
        654.6, 424.0, 0.0, 0.00, 0.00, 0.00,    //71_3  endbkrtop
        809.5, 539.9, 0.0, 0.00, 0.00, 0.00,    //72    bkrbot
        837.2, 363.2, 0.0, 0.00, 0.00, 0.00,    //73
        829.4, 364.5, 0.0, 0.00, 0.00, 0.00,    //74
        803.7, 535.8, 0.0, 0.00, 0.00, 0.00,    //75_1
        837.2, 363.2, 0.0, 0.00, 0.00, 0.00,    //76
        683.6, 129.4, 0.0, 0.00, 0.00, 0.00,    //77
        679.9, 137.7, 0.0, 0.00, 0.00, 0.00,    //78
        829.4, 364.5, 0.0, 0.00, 0.00, 0.00,    //79_2  endbkrbot
        73.80, 378.8, 0.0, 0.00, 0.00, 0.00,    //80    ftlbot
        197.2, 506.1, 0.0, 0.00, 0.00, 0.00,    //81
        210.2, 486.8, 0.0, 0.00, 0.00, 0.00,    //82
        79.80, 357.5, 0.0, 0.00, 0.00, 0.00,    //83_1
